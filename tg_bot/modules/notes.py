    ...
    if note:
        ...
        if note.is_reply:
            ...
            try:
                ...
                elif note.msgtype == sql.Types.DOCUMENT:
                ...
                elif note.msgtype == sql.Types.PHOTO:
                ...
                elif note.msgtype == sql.Types.AUDIO:
                ...
                elif note.msgtype == sql.Types.VOICE:
                ...
                elif note.msgtype == sql.Types.VIDEO:
...
async def slash_get(update: Update, context: ContextTypes.DEFAULT_TYPE):
    message_text, chat_id = update.effective_message.text, update.effective_chat.id
    no_slash = message_text[1:]
